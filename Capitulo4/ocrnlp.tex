...
\begin{enumerate}
    ...
    la estructura definida en la Sección~4.X.2.
    ...
    descrito en la Sección~4.X+1, reflejando el nuevo promedio acumulado
    del alumno.
\end{enumerate}
...
/* Tabla Intentos — campo a actualizar */
{
  "texto_detectado_ocr": "string (texto reconocido)"
}

/* Tabla Analisis_Caligrafico — registro a insertar */
{
  "id_intento":          <integer>,
...
/* Tabla Analisis_Ortografico — registro a insertar */
{
  "id_intento":        <integer>,
...
\begin{itemize}
    ...
    de molde (tipografía Century), conforme al objetivo específico OE-03
