...
\begin{figure}[H]
    \centering
    \includegraphics[angle=90,width=0.56\textheight]{Imagenes/Diagrama-entidad-relacion.png}
    \caption{Diagrama entidad–relación propuesto}
    \label{fig:er}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[angle=90,width=0.4\textheight]{Imagenes/DiagramaRelaiconal-2.png}
