...
\textbf{Salida:} Lista de actividades de refuerzo sugeridas enfocadas en las áreas de oportunidad detectadas. \\ \hline
\multicolumn{2}{|p{15cm}|}{
\textbf{Descripción:} La aplicación web genera recomendaciones de actividades de mejora personalizadas para el alumno. 
...
\vspace{0.2cm}
\textbf{Postcondición:} Las actividades sugeridas quedan registradas y disponibles para que el alumno las consulte.
} \\ \hline
\end{tabular}
\label{tab:rf30}
\end{table}
...
\begin{longtable}{|p{7cm}|p{8cm}|}
    ...
    \multicolumn{2}{|p{15cm}|}{\textbf{Requerimiento:} La aplicación web permitirá al alumno realizar actividades de refuerzo sugeridas a partir de las áreas de oportunidad detectadas previamente en ortografía y caligrafía.} \\ \hline
    ...
    \textbf{Entrada:} Actividad sugerida seleccionada por el alumno desde su lista de recomendaciones. &
    \textbf{Salida:} Registro de la actividad de refuerzo realizada por el alumno y disponible para validación por parte del profesor. \\ \hline
    
    \multicolumn{2}{|p{15cm}|}{
    \textbf{Descripción:} El alumno selecciona una actividad sugerida y la realiza mediante el módulo de captura de escritura (RF-17 al RF-25) con el propósito de reforzar las áreas de oportunidad identificadas previamente por el sistema.
    
    Las actividades de refuerzo tendrán un carácter complementario y de práctica autónoma, por lo que no generarán un nuevo intento evaluado ni serán sometidas nuevamente a análisis por los módulos OCR (RF-26) y NLP (RF-27). La realización de la actividad podrá ser consultada y validada posteriormente por el profesor.
    
    \vspace{0.2cm}
    \textbf{Precondición:} El alumno debe estar autenticado y tener actividades sugeridas disponibles.
    
    \vspace{0.2cm}
    \textbf{Postcondición:} La actividad realizada queda registrada en el historial del alumno como actividad de práctica completada y disponible para revisión o validación docente.
    } \\ \hline
