...
\lstdefinelanguage{JavaScript}{
  keywords={const, let, var, async, await, return, if, else},
  sensitive=true,
  comment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]',
...
\begin{titlepage}
    ...
    {\Large\bfseries\centering
        ``Aplicación Web para la práctica de escritura a mano y\\[-0.5em]
...
\begin{description}
    \item[Gamificación:] Técnica de diseño que incorpora elementos de videojuegos (puntuación, badges, niveles, competencia) en contextos educativos no lúdicos. En este proyecto, incentiva la práctica de escritura manuscrita mediante recompensas y progresión visible, aumentando la motivación del estudiante.
    \item[Retroalimentación en tiempo real:] Respuesta inmediata y continua proporcionada al usuario durante la realización de una actividad, permitiendo corregir errores instantáneamente en lugar de solo después de completar la tarea. En el sistema, guía al alumno sobre la calidad de su escritura mientras escribe.
    \item[Legibilidad:] Capacidad de ser leído y comprendido fácilmente. En el contexto de escritura manuscrita, evalúa aspectos como claridad, consistencia del tamaño, alineación y espaciado que facilitan la lectura de la escritura por otros.
    \item[Trazo manuscrito:] Línea o marca continua creada por movimiento manual al escribir. En este proyecto, es capturado digitalmente mediante el Canvas HTML5 y analizado por algoritmos de OCR para reconocimiento y evaluación de calidad.
    \item[Caligrafía:] Técnica y arte de escribir con características técnicas, estéticas y bien ejecutadas. En educación primaria, enseña las formas correctas de las letras del alfabeto y desarrolla habilidades motrices finas necesarias para la escritura clara y legible.
    \item[Segmentación de caracteres:] Proceso de división de una imagen que contiene múltiples caracteres en regiones individuales, donde cada una contiene un único carácter. Es fundamental en OCR para reconocer cada letra por separado antes de su clasificación.
    \item[Aprendizaje adaptativo:] Enfoque pedagógico que ajusta el contenido, nivel de dificultad y ritmo de enseñanza según el desempeño y necesidades específicas de cada estudiante, personalizando la experiencia educativa.
    \item[Lectoescritura:] Capacidad integrada de leer y escribir, considerada fundamental en educación primaria. Implica no solo el reconocimiento de letras sino también la comprensión de textos y la expresión de ideas por escrito.
    \item[Retroalimentación formativa:] Información evaluativa proporcionada durante el proceso de aprendizaje cuyo propósito es mejorar el desempeño del estudiante, identificando fortalezas y áreas de mejora para guiar el aprendizaje futuro.
    \item[Corrección ortográfica automática:] Proceso computacional que detecta y sugiere correcciones para errores de ortografía y puntuación en textos, utilizando algoritmos de NLP como la Distancia de Levenshtein para proponer alternativas válidas.
